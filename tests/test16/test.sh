...
koviz DP_linear a.csv b.csv
echo "Linear Linear: (0,74),(0,434) (PDF)"
koviz DP_linear a.csv b.csv -pdf moo.pdf
evince moo.pdf
rm moo.pdf
...
koviz DP_linear a.csv b.csv -pres error
echo "Expect Error plot Flatpoint=(0,-360) -360=74-434 (PDF)"
koviz DP_linear a.csv b.csv -pres error -pdf moo.pdf
evince moo.pdf
rm moo.pdf

echo "Expect Error plot Logx: Empty"
koviz DP_logx a.csv b.csv -pres error
echo "Expect Error plot Logx: Empty (PDF)"
koviz DP_logx a.csv b.csv -pres error -pdf moo.pdf
evince moo.pdf
rm moo.pdf

echo "Expect Error plot Logy: Flatpoint=(0,360) (logy flips -360)"
koviz DP_logy a.csv b.csv -pres error
echo "Expect Error plot Logy: Flatpoint=(0,360) (logy flips -360) (PDF)"
koviz DP_logy a.csv b.csv -pres error -pdf moo.pdf
evince moo.pdf
rm moo.pdf

echo "Expect Error plot Logxy: Empty"
koviz DP_logxy a.csv b.csv -pres error
echo "Expect Error plot Logxy: Empty (PDF)"
koviz DP_logxy a.csv b.csv -pres error -pdf moo.pdf
evince moo.pdf
rm moo.pdf
